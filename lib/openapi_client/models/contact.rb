...
module OpenapiClient
  ...
  class Contact
    ...
    attr_accessor :needs_verification
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Contact`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fallback_email')
        self.fallback_email = attributes[:'fallback_email']
      end

      if attributes.key?(:'needs_verification')
        self.needs_verification = attributes[:'needs_verification']
      end
    end
    ...
    def hash
      [email, fallback_email, needs_verification].hash
    end

  ...
  class DnsPreferences
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DnsPreferences` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DnsPreferences`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'magic_dns')
        self.magic_dns = attributes[:'magic_dns']
      else
        self.magic_dns = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @magic_dns.nil?
        invalid_properties.push('invalid value for "magic_dns", magic_dns cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @magic_dns.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] magic_dns Value to be assigned
    def magic_dns=(magic_dns)
      if magic_dns.nil?
        fail ArgumentError, 'magic_dns cannot be nil'
      end

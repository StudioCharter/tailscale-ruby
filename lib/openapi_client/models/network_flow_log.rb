...
module OpenapiClient
  class NetworkFlowLog
    ...
    attr_accessor :virtual_traffic

    attr_accessor :subnet_traffic

    attr_accessor :exit_traffic

    attr_accessor :physical_traffic
    ...
    def self.attribute_map
      {
        ...
        :'start' => :'start',
        :'_end' => :'end',
        :'virtual_traffic' => :'virtualTraffic',
        :'subnet_traffic' => :'subnetTraffic',
        :'exit_traffic' => :'exitTraffic',
    ...
    def self.openapi_types
      {
        ...
        :'start' => :'String',
        :'_end' => :'String',
        :'virtual_traffic' => :'Array<ConnectionCounts>',
        :'subnet_traffic' => :'Array<ConnectionCounts>',
        :'exit_traffic' => :'Array<ConnectionCounts>',
        :'physical_traffic' => :'Array<ConnectionCounts>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::NetworkFlowLog` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::NetworkFlowLog`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'virtual_traffic')
        if (value = attributes[:'virtual_traffic']).is_a?(Array)
          self.virtual_traffic = value
        end
      end

      if attributes.key?(:'subnet_traffic')
        if (value = attributes[:'subnet_traffic']).is_a?(Array)
          self.subnet_traffic = value
        end
      end

      if attributes.key?(:'exit_traffic')
        if (value = attributes[:'exit_traffic']).is_a?(Array)
          self.exit_traffic = value
        end
      end

      if attributes.key?(:'physical_traffic')
        if (value = attributes[:'physical_traffic']).is_a?(Array)
          self.physical_traffic = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          start == o.start &&
          _end == o._end &&
          virtual_traffic == o.virtual_traffic &&
          subnet_traffic == o.subnet_traffic &&
          exit_traffic == o.exit_traffic &&
          physical_traffic == o.physical_traffic
    end
    ...
    def hash
      [logged, node_id, start, _end, virtual_traffic, subnet_traffic, exit_traffic, physical_traffic].hash
    end

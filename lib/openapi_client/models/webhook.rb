...
module OpenapiClient
  class Webhook
    ...
    # The login name for the creator of the webhook endpoint. In some cases, such as webhooks created with an OAuth client, this can be blank. 
    attr_accessor :creator_login_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'creator_login_name')
        self.creator_login_name = attributes[:'creator_login_name']
      end
    ...
    def valid?
      ...
      provider_type_validator = EnumAttributeValidator.new('String', ["slack", "mattermost", "googlechat", "discord"])
    ...
    def provider_type=(provider_type)
      validator = EnumAttributeValidator.new('String', ["slack", "mattermost", "googlechat", "discord"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          creator_login_name == o.creator_login_name &&
          created == o.created &&
    ...
    def hash
      [endpoint_id, endpoint_url, provider_type, creator_login_name, created, last_modified, subscriptions, secret].hash
    end

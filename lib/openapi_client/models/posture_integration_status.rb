...
module OpenapiClient
  ...
  class PostureIntegrationStatus
    ...
    attr_accessor :provider_host_count
    ...
    attr_accessor :possible_matched_count
    ...
    def self.attribute_map
      {
        :'last_sync' => :'lastSync',
        :'error' => :'error',
        :'provider_host_count' => :'providerHostCount',
        :'matched_count' => :'matchedCount',
        :'possible_matched_count' => :'possibleMatchedCount'
      }
    end
    ...
    def self.openapi_types
      {
        :'last_sync' => :'String',
        :'error' => :'String',
        :'provider_host_count' => :'Integer',
        :'matched_count' => :'Integer',
        :'possible_matched_count' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PostureIntegrationStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PostureIntegrationStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'provider_host_count')
        self.provider_host_count = attributes[:'provider_host_count']
      end

      if attributes.key?(:'matched_count')
        self.matched_count = attributes[:'matched_count']
      end

      if attributes.key?(:'possible_matched_count')
        self.possible_matched_count = attributes[:'possible_matched_count']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error == o.error &&
          provider_host_count == o.provider_host_count &&
          matched_count == o.matched_count &&
          possible_matched_count == o.possible_matched_count
    end
    ...
    def hash
      [last_sync, error, provider_host_count, matched_count, possible_matched_count].hash
    end

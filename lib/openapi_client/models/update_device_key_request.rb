  ...
  class UpdateDeviceKeyRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UpdateDeviceKeyRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UpdateDeviceKeyRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @key_expiry_disabled.nil?
        invalid_properties.push('invalid value for "key_expiry_disabled", key_expiry_disabled cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @key_expiry_disabled.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] key_expiry_disabled Value to be assigned
    def key_expiry_disabled=(key_expiry_disabled)
      if key_expiry_disabled.nil?
        fail ArgumentError, 'key_expiry_disabled cannot be nil'
      end

...
module OpenapiClient
  ...
  class AwsExternalId
    ...
    attr_accessor :tailscale_aws_account_id

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'external_id' => :'externalId',
        :'tailscale_aws_account_id' => :'tailscaleAwsAccountId'
      }
    end
    ...
    def self.openapi_types
      {
        :'external_id' => :'String',
        :'tailscale_aws_account_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AwsExternalId` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AwsExternalId`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tailscale_aws_account_id')
        self.tailscale_aws_account_id = attributes[:'tailscale_aws_account_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tailscale_aws_account_id == o.tailscale_aws_account_id
    end
    ...
    def hash
      [external_id, tailscale_aws_account_id].hash
    end

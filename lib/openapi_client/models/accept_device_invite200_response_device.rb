...
module OpenapiClient
  ...
  class AcceptDeviceInvite200ResponseDevice
    ...
    attr_accessor :include_exit_node
    ...
    def self.attribute_map
      {
        ...
        :'ipv4' => :'ipv4',
        :'ipv6' => :'ipv6',
        :'include_exit_node' => :'includeExitNode'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AcceptDeviceInvite200ResponseDevice` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AcceptDeviceInvite200ResponseDevice`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'include_exit_node')
        self.include_exit_node = attributes[:'include_exit_node']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipv4 == o.ipv4 &&
          ipv6 == o.ipv6 &&
          include_exit_node == o.include_exit_node
    end
    ...
    def hash
      [id, os, name, fqdn, ipv4, ipv6, include_exit_node].hash
    end

...
module OpenapiClient
  ...
  class DeviceClientConnectivity
    ...
    attr_accessor :mapping_varies_by_dest_ip

    # Map of DERP server locations and their current latency.
    attr_accessor :latency

    attr_accessor :client_supports

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'endpoints' => :'endpoints',
        :'mapping_varies_by_dest_ip' => :'mappingVariesByDestIP',
        :'latency' => :'latency',
    ...
    def self.openapi_types
      {
        ...
        :'mapping_varies_by_dest_ip' => :'Boolean',
        :'latency' => :'Hash<String, DeviceClientConnectivityLatencyValue>',
        :'client_supports' => :'DeviceClientConnectivityClientSupports'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DeviceClientConnectivity` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DeviceClientConnectivity`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mapping_varies_by_dest_ip')
        self.mapping_varies_by_dest_ip = attributes[:'mapping_varies_by_dest_ip']
      end
      ...
      if attributes.key?(:'client_supports')
        self.client_supports = attributes[:'client_supports']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mapping_varies_by_dest_ip == o.mapping_varies_by_dest_ip &&
          latency == o.latency &&
          client_supports == o.client_supports
    end
    ...
    def hash
      [endpoints, mapping_varies_by_dest_ip, latency, client_supports].hash
    end

...
module OpenapiClient
  class PreviewRuleMatches200Response
    ...
    def self.openapi_types
      {
        :'matches' => :'Array<PreviewRuleMatches200ResponseMatchesInner>',
        :'type' => :'String',
        :'preview_for' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PreviewRuleMatches200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PreviewRuleMatches200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'preview_for')
        self.preview_for = attributes[:'preview_for']
      else
        self.preview_for = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @preview_for.nil?
        invalid_properties.push('invalid value for "preview_for", preview_for cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @preview_for.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] matches Value to be assigned
    def matches=(matches)
      if matches.nil?
        fail ArgumentError, 'matches cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] preview_for Value to be assigned
    def preview_for=(preview_for)
      if preview_for.nil?
        fail ArgumentError, 'preview_for cannot be nil'
      end

...
module OpenapiClient
  ...
  class DeviceInvite
    # The unique identifier for the invite. Supply this value wherever {deviceInviteId} is indicated in the endpoint. 
    attr_accessor :id
    ...
    attr_accessor :sharer_id

    # Specifies whether this device invite can be accepted more than once. 
    attr_accessor :multi_use

    # Specifies whether the invited user is able to use the device as an exit node when the device is advertising as one. 
    attr_accessor :allow_exit_node
    ...
    # The link to accept the invite. Anyone with this link can accept the invite. It is not restricted to the person to which the invite was emailed. 
    ...
    def self.openapi_types
      {
        ...
        :'invite_url' => :'String',
        :'accepted' => :'Boolean',
        :'accepted_by' => :'DeviceInviteAcceptedBy'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DeviceInvite` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DeviceInvite`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sharer_id')
        self.sharer_id = attributes[:'sharer_id']
      end

      if attributes.key?(:'multi_use')
        self.multi_use = attributes[:'multi_use']
      end

      if attributes.key?(:'allow_exit_node')
        self.allow_exit_node = attributes[:'allow_exit_node']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sharer_id == o.sharer_id &&
          multi_use == o.multi_use &&
          allow_exit_node == o.allow_exit_node &&
          email == o.email &&
    ...
    def hash
      [id, created, tailnet_id, device_id, sharer_id, multi_use, allow_exit_node, email, last_email_sent_at, invite_url, accepted, accepted_by].hash
    end

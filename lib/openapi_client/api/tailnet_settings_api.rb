...
module OpenapiClient
  class TailnetSettingsApi
    ...
    def get_tailnet_settings(tailnet, opts = {})
      data, _status_code, _headers = get_tailnet_settings_with_http_info(tailnet, opts)
      data
    end
    ...
    # @param tailnet [String] The tailnet organization name.  When specifying a tailnet in the API, you can:  - Provide a dash (&#x60;-&#x60;) to reference the default tailnet of the access token being used to make the API call.   This is the best option for most users.   Your API calls would start:    &#x60;&#x60;&#x60;sh   curl \&quot;https://api.tailscale.com/api/v2/tailnet/-/...\&quot;   &#x60;&#x60;&#x60;  - Provide the **organization** name found on the **[General Settings](https://login.tailscale.com/admin/settings/general)**   page of the Tailscale admin console (not to be confused with the \&quot;tailnet name\&quot; found in the DNS tab).    For example, if your organization name is &#x60;alice@example.com&#x60;, your API calls would start:    &#x60;&#x60;&#x60;sh   curl \&quot;https://api.tailscale.com/api/v2/tailnet/alice@example.com/...\&quot;   &#x60;&#x60;&#x60;    Learn more about [tailnet organization names](https://tailscale.com/kb/1217/tailnet-name#organization-name). 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TailnetSettings, Integer, Hash)>] TailnetSettings data, response status code and response headers
    def get_tailnet_settings_with_http_info(tailnet, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TailnetSettingsApi.get_tailnet_settings ...'
      end
      # verify the required parameter 'tailnet' is set
      if @api_client.config.client_side_validation && tailnet.nil?
        fail ArgumentError, "Missing the required parameter 'tailnet' when calling TailnetSettingsApi.get_tailnet_settings"
      end
      # resource path
      local_var_path = '/tailnet/{tailnet}/settings'.sub('{' + 'tailnet' + '}', CGI.escape(tailnet.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TailnetSettings'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"TailnetSettingsApi.get_tailnet_settings",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TailnetSettingsApi#get_tailnet_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [TailnetSettings]
    def update_tailnet_settings(tailnet, opts = {})
      data, _status_code, _headers = update_tailnet_settings_with_http_info(tailnet, opts)
      data
    end
    ...
    # @option opts [TailnetSettings] :tailnet_settings 
    # @return [Array<(TailnetSettings, Integer, Hash)>] TailnetSettings data, response status code and response headers
    def update_tailnet_settings_with_http_info(tailnet, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TailnetSettingsApi.update_tailnet_settings ...'
      end
      # verify the required parameter 'tailnet' is set
      if @api_client.config.client_side_validation && tailnet.nil?
        fail ArgumentError, "Missing the required parameter 'tailnet' when calling TailnetSettingsApi.update_tailnet_settings"
      end
      # resource path
      local_var_path = '/tailnet/{tailnet}/settings'.sub('{' + 'tailnet' + '}', CGI.escape(tailnet.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'tailnet_settings'])
      ...
      new_options = opts.merge(
        :operation => :"TailnetSettingsApi.update_tailnet_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TailnetSettingsApi#update_tailnet_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end

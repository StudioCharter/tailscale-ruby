...
module OpenapiClient
  class DevicePostureApi
    ...
    def create_posture_integration(tailnet, opts = {})
      data, _status_code, _headers = create_posture_integration_with_http_info(tailnet, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [PostureIntegration] :posture_integration 
    # @return [Array<(PostureIntegration, Integer, Hash)>] PostureIntegration data, response status code and response headers
    def create_posture_integration_with_http_info(tailnet, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DevicePostureApi.create_posture_integration ...'
      end
      # verify the required parameter 'tailnet' is set
      if @api_client.config.client_side_validation && tailnet.nil?
        fail ArgumentError, "Missing the required parameter 'tailnet' when calling DevicePostureApi.create_posture_integration"
      end
      # resource path
      local_var_path = '/tailnet/{tailnet}/posture/integrations'.sub('{' + 'tailnet' + '}', CGI.escape(tailnet.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'posture_integration'])

      # return_type
      return_type = opts[:debug_return_type] || 'PostureIntegration'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"DevicePostureApi.create_posture_integration",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DevicePostureApi#create_posture_integration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param id [String] Unique identifier for a posture integration.
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_posture_integration(id, opts = {})
      delete_posture_integration_with_http_info(id, opts)
      nil
    end
    ...
    def delete_posture_integration_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DevicePostureApi.delete_posture_integration ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DevicePostureApi.delete_posture_integration"
      end
      # resource path
      local_var_path = '/posture/integrations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DevicePostureApi.delete_posture_integration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DevicePostureApi#delete_posture_integration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [PostureIntegration]
    def get_posture_integration(id, opts = {})
      data, _status_code, _headers = get_posture_integration_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PostureIntegration, Integer, Hash)>] PostureIntegration data, response status code and response headers
    def get_posture_integration_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DevicePostureApi.get_posture_integration ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DevicePostureApi.get_posture_integration"
      end
      # resource path
      local_var_path = '/posture/integrations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DevicePostureApi.get_posture_integration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DevicePostureApi#get_posture_integration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_posture_integrations(tailnet, opts = {})
      data, _status_code, _headers = get_posture_integrations_with_http_info(tailnet, opts)
      data
    end
    ...
    # @param tailnet [String] The tailnet organization name.  When specifying a tailnet in the API, you can:  - Provide a dash (&#x60;-&#x60;) to reference the default tailnet of the access token being used to make the API call.   This is the best option for most users.   Your API calls would start:    &#x60;&#x60;&#x60;sh   curl \&quot;https://api.tailscale.com/api/v2/tailnet/-/...\&quot;   &#x60;&#x60;&#x60;  - Provide the **organization** name found on the **[General Settings](https://login.tailscale.com/admin/settings/general)**   page of the Tailscale admin console (not to be confused with the \&quot;tailnet name\&quot; found in the DNS tab).    For example, if your organization name is &#x60;alice@example.com&#x60;, your API calls would start:    &#x60;&#x60;&#x60;sh   curl \&quot;https://api.tailscale.com/api/v2/tailnet/alice@example.com/...\&quot;   &#x60;&#x60;&#x60;    Learn more about [tailnet organization names](https://tailscale.com/kb/1217/tailnet-name#organization-name). 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetPostureIntegrations200Response, Integer, Hash)>] GetPostureIntegrations200Response data, response status code and response headers
    def get_posture_integrations_with_http_info(tailnet, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DevicePostureApi.get_posture_integrations ...'
      end
      # verify the required parameter 'tailnet' is set
      if @api_client.config.client_side_validation && tailnet.nil?
        fail ArgumentError, "Missing the required parameter 'tailnet' when calling DevicePostureApi.get_posture_integrations"
      end
      # resource path
      local_var_path = '/tailnet/{tailnet}/posture/integrations'.sub('{' + 'tailnet' + '}', CGI.escape(tailnet.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPostureIntegrations200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"DevicePostureApi.get_posture_integrations",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DevicePostureApi#get_posture_integrations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [PostureIntegration] :posture_integration 
    # @return [PostureIntegration]
    def update_posture_integration(id, opts = {})
      data, _status_code, _headers = update_posture_integration_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [PostureIntegration] :posture_integration 
    # @return [Array<(PostureIntegration, Integer, Hash)>] PostureIntegration data, response status code and response headers
    def update_posture_integration_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DevicePostureApi.update_posture_integration ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DevicePostureApi.update_posture_integration"
      end
      # resource path
      local_var_path = '/posture/integrations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DevicePostureApi.update_posture_integration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DevicePostureApi#update_posture_integration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end

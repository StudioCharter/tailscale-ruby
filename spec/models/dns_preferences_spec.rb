...
# Unit tests for OpenapiClient::DnsPreferences
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DnsPreferences do
  let(:instance) { OpenapiClient::DnsPreferences.new }

  describe 'test an instance of DnsPreferences' do
    it 'should create an instance of DnsPreferences' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DnsPreferences)
    end
  end

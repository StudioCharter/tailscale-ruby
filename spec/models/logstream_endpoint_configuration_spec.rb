...
# Unit tests for OpenapiClient::LogstreamEndpointConfiguration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LogstreamEndpointConfiguration do
  let(:instance) { OpenapiClient::LogstreamEndpointConfiguration.new }

  describe 'test an instance of LogstreamEndpointConfiguration' do
    it 'should create an instance of LogstreamEndpointConfiguration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::LogstreamEndpointConfiguration)
    end
  end
  ...
  describe 'test attribute "destination_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["splunk", "elastic", "panther", "cribl", "datadog", "axiom", "s3"])
  ...
  describe 'test attribute "upload_period_minutes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "compression_format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["zstd", "gzip", "none"])
      # validator.allowable_values.each do |value|
      #   expect { instance.compression_format = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "s3_region"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "s3_key_prefix"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "s3_authentication_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["accesskey", "rolearn"])
      # validator.allowable_values.each do |value|
      #   expect { instance.s3_authentication_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "s3_access_key_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "s3_secret_access_key"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "s3_role_arn"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "s3_external_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

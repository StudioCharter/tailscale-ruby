...
# Unit tests for OpenapiClient::ConnectionCounts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ConnectionCounts do
  let(:instance) { OpenapiClient::ConnectionCounts.new }

  describe 'test an instance of ConnectionCounts' do
    it 'should create an instance of ConnectionCounts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ConnectionCounts)
    end
  end
  ...
  describe 'test attribute "proto"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ah", "dccp", "egp", "esp", "gre", "icmp", "igmp", "igp", "ipv4", "ipv6-icmp", "sctp", "tcp", "udp"])
      # validator.allowable_values.each do |value|
      #   expect { instance.proto = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "tx_pkts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "rx_pkts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

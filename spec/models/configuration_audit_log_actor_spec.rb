...
# Unit tests for OpenapiClient::ConfigurationAuditLogActor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ConfigurationAuditLogActor do
  let(:instance) { OpenapiClient::ConfigurationAuditLogActor.new }

  describe 'test an instance of ConfigurationAuditLogActor' do
    it 'should create an instance of ConfigurationAuditLogActor' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ConfigurationAuditLogActor)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["USER", "NODE", "AUTOMATED_WORKER", "OAUTH_CLIENT", "SCIM", "MULLVAD", "LOGSTREAM", "SECRET_SCANNER"])

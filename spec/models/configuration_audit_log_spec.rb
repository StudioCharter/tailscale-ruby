...
# Unit tests for OpenapiClient::ConfigurationAuditLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ConfigurationAuditLog do
  let(:instance) { OpenapiClient::ConfigurationAuditLog.new }

  describe 'test an instance of ConfigurationAuditLog' do
    it 'should create an instance of ConfigurationAuditLog' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ConfigurationAuditLog)
    end
  end
  ...
  describe 'test attribute "deferred_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "event_group_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "origin"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ADMIN_CONSOLE", "CONFIG_API", "CONTROL", "IDENTITY_PROVIDER", "NODE", "SUPPORT_REQUEST", "STRIPE", "SECURITY_NOTIFICATION", "LEGAL_NOTIFICATION"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "action"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["LOGIN", "LOGOUT", "CREATE", "UPDATE", "DELETE", "CANCEL", "REVOKE", "APPROVE", "SUSPEND", "RESTORE", "ENABLE", "DISABLE", "ACCEPT", "EXPIRED", "PUSH_USER", "PUSH_GROUP", "VERIFY", "JOIN_WAITLIST", "INVITE", "JOIN", "LEAVE", "RESEND", "MIGRATE_AUTH_PROVIDER"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "action_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

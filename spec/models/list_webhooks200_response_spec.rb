...
# Unit tests for OpenapiClient::ListWebhooks200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListWebhooks200Response do
  let(:instance) { OpenapiClient::ListWebhooks200Response.new }

  describe 'test an instance of ListWebhooks200Response' do
    it 'should create an instance of ListWebhooks200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListWebhooks200Response)
    end
  end

...
# Unit tests for OpenapiClient::DeviceRoutes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeviceRoutes do
  let(:instance) { OpenapiClient::DeviceRoutes.new }

  describe 'test an instance of DeviceRoutes' do
    it 'should create an instance of DeviceRoutes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeviceRoutes)
    end
  end

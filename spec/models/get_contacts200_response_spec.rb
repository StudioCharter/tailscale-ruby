...
# Unit tests for OpenapiClient::GetContacts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetContacts200Response do
  let(:instance) { OpenapiClient::GetContacts200Response.new }

  describe 'test an instance of GetContacts200Response' do
    it 'should create an instance of GetContacts200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetContacts200Response)
    end
  end

...
# Unit tests for OpenapiClient::DeviceInvite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeviceInvite do
  let(:instance) { OpenapiClient::DeviceInvite.new }

  describe 'test an instance of DeviceInvite' do
    it 'should create an instance of DeviceInvite' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeviceInvite)
    end
  end
  ...
  describe 'test attribute "sharer_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "allow_exit_node"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

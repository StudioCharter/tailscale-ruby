...
# Unit tests for OpenapiClient::SetDnsNameservers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SetDnsNameservers200Response do
  let(:instance) { OpenapiClient::SetDnsNameservers200Response.new }

  describe 'test an instance of SetDnsNameservers200Response' do
    it 'should create an instance of SetDnsNameservers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SetDnsNameservers200Response)
    end
  end
  ...
  describe 'test attribute "magic_dns"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

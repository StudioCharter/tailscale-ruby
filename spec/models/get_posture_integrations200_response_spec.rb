...
# Unit tests for OpenapiClient::GetPostureIntegrations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetPostureIntegrations200Response do
  let(:instance) { OpenapiClient::GetPostureIntegrations200Response.new }

  describe 'test an instance of GetPostureIntegrations200Response' do
    it 'should create an instance of GetPostureIntegrations200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetPostureIntegrations200Response)
    end
  end

...
# Unit tests for OpenapiClient::AcceptDeviceInvite200ResponseAcceptedBy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AcceptDeviceInvite200ResponseAcceptedBy do
  let(:instance) { OpenapiClient::AcceptDeviceInvite200ResponseAcceptedBy.new }

  describe 'test an instance of AcceptDeviceInvite200ResponseAcceptedBy' do
    it 'should create an instance of AcceptDeviceInvite200ResponseAcceptedBy' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AcceptDeviceInvite200ResponseAcceptedBy)
    end
  end

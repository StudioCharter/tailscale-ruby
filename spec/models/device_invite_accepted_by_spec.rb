...
# Unit tests for OpenapiClient::DeviceInviteAcceptedBy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeviceInviteAcceptedBy do
  let(:instance) { OpenapiClient::DeviceInviteAcceptedBy.new }

  describe 'test an instance of DeviceInviteAcceptedBy' do
    it 'should create an instance of DeviceInviteAcceptedBy' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeviceInviteAcceptedBy)
    end
  end

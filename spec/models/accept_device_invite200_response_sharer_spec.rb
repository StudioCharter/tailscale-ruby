...
# Unit tests for OpenapiClient::AcceptDeviceInvite200ResponseSharer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AcceptDeviceInvite200ResponseSharer do
  let(:instance) { OpenapiClient::AcceptDeviceInvite200ResponseSharer.new }

  describe 'test an instance of AcceptDeviceInvite200ResponseSharer' do
    it 'should create an instance of AcceptDeviceInvite200ResponseSharer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AcceptDeviceInvite200ResponseSharer)
    end
  end

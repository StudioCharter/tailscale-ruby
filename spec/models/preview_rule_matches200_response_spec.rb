...
# Unit tests for OpenapiClient::PreviewRuleMatches200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PreviewRuleMatches200Response do
  let(:instance) { OpenapiClient::PreviewRuleMatches200Response.new }

  describe 'test an instance of PreviewRuleMatches200Response' do
    it 'should create an instance of PreviewRuleMatches200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PreviewRuleMatches200Response)
    end
  end
  ...
  describe 'test attribute "preview_for"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for OpenapiClient::TailnetSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TailnetSettings do
  let(:instance) { OpenapiClient::TailnetSettings.new }

  describe 'test an instance of TailnetSettings' do
    it 'should create an instance of TailnetSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TailnetSettings)
    end
  end

  describe 'test attribute "devices_approval_on"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "devices_auto_updates_on"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "devices_key_duration_days"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "users_approval_on"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "users_role_allowed_to_join_external_tailnets"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "admin", "member"])
      # validator.allowable_values.each do |value|
      #   expect { instance.users_role_allowed_to_join_external_tailnets = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "network_flow_logging_on"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "regional_routing_on"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "posture_identity_collection_on"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for OpenapiClient::UpdateWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateWebhookRequest do
  let(:instance) { OpenapiClient::UpdateWebhookRequest.new }

  describe 'test an instance of UpdateWebhookRequest' do
    it 'should create an instance of UpdateWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateWebhookRequest)
    end
  end

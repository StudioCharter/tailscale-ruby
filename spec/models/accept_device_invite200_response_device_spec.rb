...
# Unit tests for OpenapiClient::AcceptDeviceInvite200ResponseDevice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AcceptDeviceInvite200ResponseDevice do
  let(:instance) { OpenapiClient::AcceptDeviceInvite200ResponseDevice.new }

  describe 'test an instance of AcceptDeviceInvite200ResponseDevice' do
    it 'should create an instance of AcceptDeviceInvite200ResponseDevice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AcceptDeviceInvite200ResponseDevice)
    end
  end
  ...
  describe 'test attribute "include_exit_node"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for OpenapiClient::ValidateAwsExternalIdRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ValidateAwsExternalIdRequest do
  let(:instance) { OpenapiClient::ValidateAwsExternalIdRequest.new }

  describe 'test an instance of ValidateAwsExternalIdRequest' do
    it 'should create an instance of ValidateAwsExternalIdRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ValidateAwsExternalIdRequest)
    end
  end

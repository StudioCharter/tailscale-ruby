...
# Unit tests for OpenapiClient::ListTailnetKeys200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListTailnetKeys200Response do
  let(:instance) { OpenapiClient::ListTailnetKeys200Response.new }

  describe 'test an instance of ListTailnetKeys200Response' do
    it 'should create an instance of ListTailnetKeys200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListTailnetKeys200Response)
    end
  end

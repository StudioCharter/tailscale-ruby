...
# Unit tests for OpenapiClient::PreviewRuleMatches200ResponseMatchesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PreviewRuleMatches200ResponseMatchesInner do
  let(:instance) { OpenapiClient::PreviewRuleMatches200ResponseMatchesInner.new }

  describe 'test an instance of PreviewRuleMatches200ResponseMatchesInner' do
    it 'should create an instance of PreviewRuleMatches200ResponseMatchesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PreviewRuleMatches200ResponseMatchesInner)
    end
  end

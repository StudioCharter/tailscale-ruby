...
# Unit tests for OpenapiClient::ListConfigurationAuditLogs200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListConfigurationAuditLogs200Response do
  let(:instance) { OpenapiClient::ListConfigurationAuditLogs200Response.new }

  describe 'test an instance of ListConfigurationAuditLogs200Response' do
    it 'should create an instance of ListConfigurationAuditLogs200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListConfigurationAuditLogs200Response)
    end
  end
  ...
  describe 'test attribute "tailnet"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

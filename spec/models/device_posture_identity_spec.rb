...
# Unit tests for OpenapiClient::DevicePostureIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DevicePostureIdentity do
  let(:instance) { OpenapiClient::DevicePostureIdentity.new }

  describe 'test an instance of DevicePostureIdentity' do
    it 'should create an instance of DevicePostureIdentity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DevicePostureIdentity)
    end
  end

...
# Unit tests for OpenapiClient::SetDeviceTagsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SetDeviceTagsRequest do
  let(:instance) { OpenapiClient::SetDeviceTagsRequest.new }

  describe 'test an instance of SetDeviceTagsRequest' do
    it 'should create an instance of SetDeviceTagsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SetDeviceTagsRequest)
    end
  end

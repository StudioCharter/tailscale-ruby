...
# Unit tests for OpenapiClient::AuthorizeDeviceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthorizeDeviceRequest do
  let(:instance) { OpenapiClient::AuthorizeDeviceRequest.new }

  describe 'test an instance of AuthorizeDeviceRequest' do
    it 'should create an instance of AuthorizeDeviceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AuthorizeDeviceRequest)
    end
  end

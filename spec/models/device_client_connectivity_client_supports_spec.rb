...
# Unit tests for OpenapiClient::DeviceClientConnectivityClientSupports
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeviceClientConnectivityClientSupports do
  let(:instance) { OpenapiClient::DeviceClientConnectivityClientSupports.new }

  describe 'test an instance of DeviceClientConnectivityClientSupports' do
    it 'should create an instance of DeviceClientConnectivityClientSupports' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeviceClientConnectivityClientSupports)
    end
  end

  describe 'test attribute "hair_pinning"' do
    it 'should work' do
  ...
  describe 'test attribute "pmp"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "upnp"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for OpenapiClient::SetDeviceRoutesRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SetDeviceRoutesRequest do
  let(:instance) { OpenapiClient::SetDeviceRoutesRequest.new }

  describe 'test an instance of SetDeviceRoutesRequest' do
    it 'should create an instance of SetDeviceRoutesRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SetDeviceRoutesRequest)
    end
  end

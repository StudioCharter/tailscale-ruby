...
# Unit tests for OpenapiClient::UpdateUserRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateUserRoleRequest do
  let(:instance) { OpenapiClient::UpdateUserRoleRequest.new }

  describe 'test an instance of UpdateUserRoleRequest' do
    it 'should create an instance of UpdateUserRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateUserRoleRequest)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["owner", "member", "admin", "it-admin", "network-admin", "billing-admin", "auditor"])

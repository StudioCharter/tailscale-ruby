...
# Unit tests for OpenapiClient::CreateAuthKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateAuthKeyRequest do
  let(:instance) { OpenapiClient::CreateAuthKeyRequest.new }

  describe 'test an instance of CreateAuthKeyRequest' do
    it 'should create an instance of CreateAuthKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateAuthKeyRequest)
    end
  end
  ...
  describe 'test attribute "expiry_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

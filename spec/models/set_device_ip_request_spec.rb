...
# Unit tests for OpenapiClient::SetDeviceIpRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SetDeviceIpRequest do
  let(:instance) { OpenapiClient::SetDeviceIpRequest.new }

  describe 'test an instance of SetDeviceIpRequest' do
    it 'should create an instance of SetDeviceIpRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SetDeviceIpRequest)
    end
  end

...
# Unit tests for OpenapiClient::AcceptDeviceInvite200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AcceptDeviceInvite200Response do
  let(:instance) { OpenapiClient::AcceptDeviceInvite200Response.new }

  describe 'test an instance of AcceptDeviceInvite200Response' do
    it 'should create an instance of AcceptDeviceInvite200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AcceptDeviceInvite200Response)
    end
  end

...
# Unit tests for OpenapiClient::KeyCapabilitiesDevicesCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::KeyCapabilitiesDevicesCreate do
  let(:instance) { OpenapiClient::KeyCapabilitiesDevicesCreate.new }

  describe 'test an instance of KeyCapabilitiesDevicesCreate' do
    it 'should create an instance of KeyCapabilitiesDevicesCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::KeyCapabilitiesDevicesCreate)
    end
  end
  ...
  describe 'test attribute "preauthorized"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

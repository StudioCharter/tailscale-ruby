...
# Unit tests for OpenapiClient::AwsExternalId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AwsExternalId do
  let(:instance) { OpenapiClient::AwsExternalId.new }

  describe 'test an instance of AwsExternalId' do
    it 'should create an instance of AwsExternalId' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AwsExternalId)
    end
  end
  ...
  describe 'test attribute "tailscale_aws_account_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

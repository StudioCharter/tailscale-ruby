...
# Unit tests for OpenapiClient::ValidateAwsExternalId422Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ValidateAwsExternalId422Response do
  let(:instance) { OpenapiClient::ValidateAwsExternalId422Response.new }

  describe 'test an instance of ValidateAwsExternalId422Response' do
    it 'should create an instance of ValidateAwsExternalId422Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ValidateAwsExternalId422Response)
    end
  end

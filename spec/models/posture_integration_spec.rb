...
# Unit tests for OpenapiClient::PostureIntegration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PostureIntegration do
  let(:instance) { OpenapiClient::PostureIntegration.new }

  describe 'test an instance of PostureIntegration' do
    it 'should create an instance of PostureIntegration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PostureIntegration)
    end
  end
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["falcon", "intune", "jamfpro", "kandji", "kolide", "sentinelone"])
  ...
  describe 'test attribute "config_updated"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

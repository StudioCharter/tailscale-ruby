...
# Unit tests for OpenapiClient::KeyCapabilities
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::KeyCapabilities do
  let(:instance) { OpenapiClient::KeyCapabilities.new }

  describe 'test an instance of KeyCapabilities' do
    it 'should create an instance of KeyCapabilities' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::KeyCapabilities)
    end
  end

...
# Unit tests for OpenapiClient::DeviceClientConnectivity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeviceClientConnectivity do
  let(:instance) { OpenapiClient::DeviceClientConnectivity.new }

  describe 'test an instance of DeviceClientConnectivity' do
    it 'should create an instance of DeviceClientConnectivity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeviceClientConnectivity)
    end
  end
  ...
  describe 'test attribute "mapping_varies_by_dest_ip"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "client_supports"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

...
# Unit tests for OpenapiClient::UpdateContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateContactRequest do
  let(:instance) { OpenapiClient::UpdateContactRequest.new }

  describe 'test an instance of UpdateContactRequest' do
    it 'should create an instance of UpdateContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateContactRequest)
    end
  end

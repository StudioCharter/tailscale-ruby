...
# Unit tests for OpenapiClient::ConfigurationAuditLogTarget
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ConfigurationAuditLogTarget do
  let(:instance) { OpenapiClient::ConfigurationAuditLogTarget.new }

  describe 'test an instance of ConfigurationAuditLogTarget' do
    it 'should create an instance of ConfigurationAuditLogTarget' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ConfigurationAuditLogTarget)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["TAILNET", "USER", "GROUP", "NODE", "API_KEY", "INVITE", "SHARE", "BILLING", "ADMIN_CONSOLE", "WEB_INTERFACE", "WEBHOOK_ENDPOINT", "FAILED_REQUEST"])
  ...
  describe 'test attribute "is_ephemeral"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "property"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ACL", "ACL_TAGS", "ACCOUNT_EMAIL", "ADDRESS", "ALLOWED_IPS", "AUTO_APPROVED_ROUTES", "ATTRIBUTES", "BILLING_OWNER", "COLLECT_SERVICES", "COLLECT_POSTURE_IDENTITY", "MULLVAD_VPN", "DNS_CONFIG", "EMAIL", "EXIT_NODE", "FEATURE", "FILE_SHARING", "HTTPS", "KEY_EXPIRY_TIME", "KEY_EXPIRY", "LOG_EXIT_FLOWS", "LOGSTREAM_ENDPOINT", "MAGIC_DNS", "MACHINE_AUTH_NEEDED", "MACHINE_APPROVAL_NEEDED", "USER_APPROVAL_REQUIRED", "MACHINE_NAME", "MAX_KEY_DURATION", "NETWORK_FLOW_LOGGING", "GEOSTEERING", "NODE_SHARE", "TAILNET_INVITE", "PAYMENT_INFO", "POSTURE_IDENTITY", "POSTURE_INTEGRATION", "USER_ROLE", "SCIM", "SECURITY_EMAIL", "STRIPE_CUSTOMER_ID", "SUBSCRIPTION", "SUBSCRIBED_EVENTS", "SUPPORT_EMAIL", "SECRET", "TCD", "TKA", "AUTH_PROVIDER"])
      # validator.allowable_values.each do |value|

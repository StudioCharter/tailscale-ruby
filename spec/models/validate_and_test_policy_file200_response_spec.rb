...
# Unit tests for OpenapiClient::ValidateAndTestPolicyFile200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ValidateAndTestPolicyFile200Response do
  let(:instance) { OpenapiClient::ValidateAndTestPolicyFile200Response.new }

  describe 'test an instance of ValidateAndTestPolicyFile200Response' do
    it 'should create an instance of ValidateAndTestPolicyFile200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ValidateAndTestPolicyFile200Response)
    end
  end

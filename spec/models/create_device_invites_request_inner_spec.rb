...
# Unit tests for OpenapiClient::CreateDeviceInvitesRequestInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateDeviceInvitesRequestInner do
  let(:instance) { OpenapiClient::CreateDeviceInvitesRequestInner.new }

  describe 'test an instance of CreateDeviceInvitesRequestInner' do
    it 'should create an instance of CreateDeviceInvitesRequestInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateDeviceInvitesRequestInner)
    end
  end

...
# Unit tests for OpenapiClient::ListTailnetDevices200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListTailnetDevices200Response do
  let(:instance) { OpenapiClient::ListTailnetDevices200Response.new }

  describe 'test an instance of ListTailnetDevices200Response' do
    it 'should create an instance of ListTailnetDevices200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListTailnetDevices200Response)
    end
  end

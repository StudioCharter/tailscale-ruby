...
# Unit tests for OpenapiClient::LogType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LogType do
  let(:instance) { OpenapiClient::LogType.new }

  describe 'test an instance of LogType' do
    it 'should create an instance of LogType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::LogType)
    end
  end

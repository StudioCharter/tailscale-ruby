...
# Unit tests for OpenapiClient::ListNetworkFlowLogs200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListNetworkFlowLogs200Response do
  let(:instance) { OpenapiClient::ListNetworkFlowLogs200Response.new }

  describe 'test an instance of ListNetworkFlowLogs200Response' do
    it 'should create an instance of ListNetworkFlowLogs200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListNetworkFlowLogs200Response)
    end
  end

...
# Unit tests for OpenapiClient::ValidateAndTestPolicyFileRequestOneOfInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ValidateAndTestPolicyFileRequestOneOfInner do
  let(:instance) { OpenapiClient::ValidateAndTestPolicyFileRequestOneOfInner.new }

  describe 'test an instance of ValidateAndTestPolicyFileRequestOneOfInner' do
    it 'should create an instance of ValidateAndTestPolicyFileRequestOneOfInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ValidateAndTestPolicyFileRequestOneOfInner)
    end
  end
  ...
  describe 'test attribute "src_posture_attrs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

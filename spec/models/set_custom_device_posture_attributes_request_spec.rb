...
# Unit tests for OpenapiClient::SetCustomDevicePostureAttributesRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SetCustomDevicePostureAttributesRequest do
  let(:instance) { OpenapiClient::SetCustomDevicePostureAttributesRequest.new }

  describe 'test an instance of SetCustomDevicePostureAttributesRequest' do
    it 'should create an instance of SetCustomDevicePostureAttributesRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SetCustomDevicePostureAttributesRequest)
    end
  end

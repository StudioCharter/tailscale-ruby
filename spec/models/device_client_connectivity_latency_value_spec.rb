...
# Unit tests for OpenapiClient::DeviceClientConnectivityLatencyValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeviceClientConnectivityLatencyValue do
  let(:instance) { OpenapiClient::DeviceClientConnectivityLatencyValue.new }

  describe 'test an instance of DeviceClientConnectivityLatencyValue' do
    it 'should create an instance of DeviceClientConnectivityLatencyValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeviceClientConnectivityLatencyValue)
    end
  end

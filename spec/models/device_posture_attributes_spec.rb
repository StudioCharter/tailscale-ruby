...
# Unit tests for OpenapiClient::DevicePostureAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DevicePostureAttributes do
  let(:instance) { OpenapiClient::DevicePostureAttributes.new }

  describe 'test an instance of DevicePostureAttributes' do
    it 'should create an instance of DevicePostureAttributes' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DevicePostureAttributes)
    end
  end
  ...
  describe 'test attribute "expiries"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

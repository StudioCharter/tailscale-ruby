...
# Unit tests for OpenapiClient::AcceptDeviceInviteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AcceptDeviceInviteRequest do
  let(:instance) { OpenapiClient::AcceptDeviceInviteRequest.new }

  describe 'test an instance of AcceptDeviceInviteRequest' do
    it 'should create an instance of AcceptDeviceInviteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AcceptDeviceInviteRequest)
    end
  end

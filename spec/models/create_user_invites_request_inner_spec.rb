...
# Unit tests for OpenapiClient::CreateUserInvitesRequestInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateUserInvitesRequestInner do
  let(:instance) { OpenapiClient::CreateUserInvitesRequestInner.new }

  describe 'test an instance of CreateUserInvitesRequestInner' do
    it 'should create an instance of CreateUserInvitesRequestInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateUserInvitesRequestInner)
    end
  end

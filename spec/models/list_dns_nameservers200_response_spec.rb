...
# Unit tests for OpenapiClient::ListDnsNameservers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListDnsNameservers200Response do
  let(:instance) { OpenapiClient::ListDnsNameservers200Response.new }

  describe 'test an instance of ListDnsNameservers200Response' do
    it 'should create an instance of ListDnsNameservers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListDnsNameservers200Response)
    end
  end

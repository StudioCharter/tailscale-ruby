...
# Unit tests for OpenapiClient::GetAwsExternalIdRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetAwsExternalIdRequest do
  let(:instance) { OpenapiClient::GetAwsExternalIdRequest.new }

  describe 'test an instance of GetAwsExternalIdRequest' do
    it 'should create an instance of GetAwsExternalIdRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetAwsExternalIdRequest)
    end
  end

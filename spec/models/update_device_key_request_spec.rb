...
# Unit tests for OpenapiClient::UpdateDeviceKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateDeviceKeyRequest do
  let(:instance) { OpenapiClient::UpdateDeviceKeyRequest.new }

  describe 'test an instance of UpdateDeviceKeyRequest' do
    it 'should create an instance of UpdateDeviceKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateDeviceKeyRequest)
    end
  end

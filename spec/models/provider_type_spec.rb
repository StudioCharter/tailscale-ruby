...
# Unit tests for OpenapiClient::ProviderType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ProviderType do
  let(:instance) { OpenapiClient::ProviderType.new }

  describe 'test an instance of ProviderType' do
    it 'should create an instance of ProviderType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ProviderType)
    end
  end

...
# Unit tests for OpenapiClient::KeyCapabilitiesDevices
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::KeyCapabilitiesDevices do
  let(:instance) { OpenapiClient::KeyCapabilitiesDevices.new }

  describe 'test an instance of KeyCapabilitiesDevices' do
    it 'should create an instance of KeyCapabilitiesDevices' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::KeyCapabilitiesDevices)
    end
  end

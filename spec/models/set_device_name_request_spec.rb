...
# Unit tests for OpenapiClient::SetDeviceNameRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SetDeviceNameRequest do
  let(:instance) { OpenapiClient::SetDeviceNameRequest.new }

  describe 'test an instance of SetDeviceNameRequest' do
    it 'should create an instance of SetDeviceNameRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SetDeviceNameRequest)
    end
  end

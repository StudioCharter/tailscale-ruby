...
# Unit tests for OpenapiClient::DnsSearchPaths
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DnsSearchPaths do
  let(:instance) { OpenapiClient::DnsSearchPaths.new }

  describe 'test an instance of DnsSearchPaths' do
    it 'should create an instance of DnsSearchPaths' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DnsSearchPaths)
    end
  end

  describe 'test attribute "search_paths"' do
    it 'should work' do

...
# Unit tests for OpenapiClient::UserInvitesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UserInvitesApi' do
  before do
  ...
  describe 'test an instance of UserInvitesApi' do
    it 'should create an instance of UserInvitesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::UserInvitesApi)
    end
  end

  # unit tests for create_user_invites
  # Create user invites
  ...
  describe 'create_user_invites test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_user_invite
  # Delete a user invite
  # Deletes a specific user invite. 
  # @param user_invite_id ID of the user invite.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_user_invite test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_user_invite
  # Get a user invite
  # Retrieve a specific user invite. 
  # @param user_invite_id ID of the user invite.
  # @param [Hash] opts the optional parameters
  # @return [UserInvite]
  describe 'get_user_invite test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_user_invites
  # List user invites
  # List all open (not yet accepted) user invites to the tailnet.
  # @param tailnet The tailnet organization name.  When specifying a tailnet in the API, you can:  - Provide a dash (&#x60;-&#x60;) to reference the default tailnet of the access token being used to make the API call.   This is the best option for most users.   Your API calls would start:    &#x60;&#x60;&#x60;sh   curl \&quot;https://api.tailscale.com/api/v2/tailnet/-/...\&quot;   &#x60;&#x60;&#x60;  - Provide the **organization** name found on the **[General Settings](https://login.tailscale.com/admin/settings/general)**   page of the Tailscale admin console (not to be confused with the \&quot;tailnet name\&quot; found in the DNS tab).    For example, if your organization name is &#x60;alice@example.com&#x60;, your API calls would start:    &#x60;&#x60;&#x60;sh   curl \&quot;https://api.tailscale.com/api/v2/tailnet/alice@example.com/...\&quot;   &#x60;&#x60;&#x60;    Learn more about [tailnet organization names](https://tailscale.com/kb/1217/tailnet-name#organization-name). 
  # @param [Hash] opts the optional parameters
  # @return [Array<UserInvite>]
  describe 'list_user_invites test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for resend_user_invite
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'resend_user_invite test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
